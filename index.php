...
<body>
            ...
            <div class="back">
              <div class="card shadow card-w overflow-hidden">
                <div class="card-body row text-center align-items-center">
                  <h3>LOREM</h3>
                  <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit blanditiis saepe, fugiat sapiente nesciunt facere nisi, vitae necessitatibus maiores, suscipit cumque minima quod vel neque illo deserunt at odio esse! Lorem ipsum dolor sit amet consectetur adipisicing elit.</span>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="text-center bg-black text-light pb-1 font-monospace">Powered by <span class="text-orange">Developer
      group</span></div>
